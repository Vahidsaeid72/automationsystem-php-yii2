...
use app\models\UnreadLettersSearch;
...
/**
 * UnreadlettersController implements the CRUD actions for VwRecieveletter model.
 */
class UnreadlettersController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new UnreadLettersSearch();
