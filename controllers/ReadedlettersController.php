...
use app\models\ReadedLettersSearch;
...
/**
 * ReadedlettersController implements the CRUD actions for VwRecieveletter model.
 */
class ReadedlettersController extends Controller
{
    /**
     * {@inheritdoc}
     */
