...
use app\models\SendLettersSearch;
...
/**
 * SendlettersController implements the CRUD actions for VwRecieveletter model.
 */
class SendlettersController extends Controller
{
    /**
     * {@inheritdoc}
     */
