...
use app\models\ForceLettersSearch;
...
/**
 * ForcelettersController implements the CRUD actions for VwRecieveletter model.
 */
class ForcelettersController extends Controller
{
    /**
     * {@inheritdoc}
     */
