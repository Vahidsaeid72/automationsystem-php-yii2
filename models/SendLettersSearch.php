...
/**
 * SendLettersSearch represents the model behind the search form of `app\models\VwRecieveletter`.
 */
class SendLettersSearch extends VwRecieveletter
{
    ...
    public function search($params)
    {
        ...
        if ($UserID) {
            $query = VwRecieveletter::find()->where(['UsersID_FK' => $UserID])->andWhere(['LettersDraftType' => 2]);
        } else {
            throw new NotFoundHttpException('خطا در SendLettersSearch');
        }
