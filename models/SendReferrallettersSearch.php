 ...
 */
class SendReferrallettersSearch extends VwReferralletters
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        if (Yii::$app->user->id) {
            ...
            $query = VwReferralletters::find()->where(['UsersID_Sender' => Yii::$app->user->id]);
        } else {
            throw new NotFoundHttpException('خطا در SendReferrallettersSearch');
        }
