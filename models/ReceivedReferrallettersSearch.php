...
/**
 * ReceivedReferrallettersSearch represents the model behind the search form of `app\models\VwReferralletters`.
 */
class ReceivedReferrallettersSearch extends VwReferralletters
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        if (Yii::$app->user->id) {
            ...
            $query = VwReferralletters::find()->where(['UsersID_Receiver' => Yii::$app->user->id]);
        } else {
            throw new NotFoundHttpException('خطا در ReceivedReferrallettersSearch');
        }
