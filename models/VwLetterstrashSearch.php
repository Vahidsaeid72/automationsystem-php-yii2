...
/**
 * VwLetterstrashSearch represents the model behind the search form of `app\models\VwLetterstrash`.
 */
class VwLetterstrashSearch extends VwLetterstrash
{
    ...
    public function rules()
    {
        return [
            ...
            [['LettersSubject', 'LettersText', 'LettersAbstract', 'LettersCreateDate', 'LettersNumber', 'LettersResponseDate', 'LettersAttachmentUrl', 'LettersAttachmentFileName', 'LettersTrashDate', 'FullNameSender', 'FullNameDeletor', 'PersianLettersTypeOfAction', 'PersianLettersSecurity', 'PersianLettersArchiveType', 'PersianLettersFollowType', 'PersianLettersAttachmentType', 'PersianLettersType', 'PersianLettersResponseType', 'PersianLettersDraftType'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        if ($UserID) {
            ...
            throw new NotFoundHttpException('خطا در VwLetterstrashSearch');
        }
