...
/* @var $model app\models\VwReferralletters */
...
<div class="alert alert-info text-center">
    ...
    <h5 class="text-primary">ایجادکننده نامه : <strong><?= $model->FullCreator ?></strong></h5>
    <h5 class="text-primary">ارجاع دهنده : <strong><?= $model->FullNameSender ?></strong></h5>
    <h5 class="text-primary">تاریخ ارجاع : <strong><?= $model->ReferralLettersDate ?></strong></h5>
</div>
<div class="letters-form">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="description-tab" data-toggle="tab" href="#description" role="tab"
                aria-controls="description" aria-selected="false">توضیحات ارجاع دهنده</a>
        </li>
        <br>
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
            <?= $form->field($model, 'ReferralLettersDescription')->textarea(['rows' => 6, 'id' => 'ckeditor_description', 'readonly' => true])->label(false) ?>
        </div>
