...
~~~ js
$(document).on('page:fetch',   function() { $(".loading").fadeIn(); NProgress.start(); });
$(document).on('page:change',  function() {$(".loading").fadeOut(); NProgress.done(); });
...
~~~ js
$(document).on('pjax:start', function() { $(".loading").fadeIn(); NProgress.start(); });
$(document).on('pjax:end',   function() {$(".loading").fadeOut(); NProgress.done();  });
~~~
